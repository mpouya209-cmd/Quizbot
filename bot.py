...
# ================== بخش اصلی (اصلاح شده برای Webhook) ==================
def main():
    ...
    # اگر آدرس دامنه پیدا نشد، آدرس پروژه‌ی خودت رو جایگزین کن
    if not RAILWAY_DOMAIN:
        # آدرس دقیق پروژه‌ی شما در لاگ‌های عکس: web-production-8e010.up.railway.app
    ...
    app.run_webhook(
        ip_address="0.0.0.0", # این خط مهمه، جایگزین listen شد
        port=PORT,
        url_path=TOKEN,
